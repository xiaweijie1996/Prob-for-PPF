...
def main(): 
    ...
    mean_vector = random_sys.network_rnd.bus_info['PD'].reshape(1, -1)
    ...
    # Define the scalers
    _active_power = np.random.normal(mean_vector, scale=5, size=(5000, num_nodes-1))  # Power in kW
    ...
    for _ in range(epochs):
        ...
        active_power_node1 = np.random.normal(mean_vector, scale=5, size=(batch_size, 1))
