...
class CRealnvpflowBasic(torch.nn.Module):
    def __init__(self, 
                 input_dim: int = 2,
                 hidden_dim: int = 64,
        ...
        super(CRealnvpflowBasic, self).__init__()
...
class SimplifiedRealnvpflow(torch.nn.Module):
    def __init__(self, 
                 input_dim: int = 2,
                 hidden_dim: int = 64,
        ...
        super(SimplifiedRealnvpflow, self).__init__()
